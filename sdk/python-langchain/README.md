...
A LangChain adapter for the [NeuronEdge Enclave](https://github.com/Mindpool-Labs/ne-enclave) Runtime API. Gives an LLM agent a managed, confidential Firecracker microVM sandbox: run shell commands and move files in/out.
